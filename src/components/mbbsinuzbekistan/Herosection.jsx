  ...
  return (
    <>
      ...
      <div className='flex items-center justify-center sm:mt-[100px] '>
                <div className='h-fit w-[90%] flex flex-col gap-4  '>
                    ...
                    <div className='text-justify text-sm'>
                        <p>Studying MBBS in Uzbekistan has been one of the most preferred options for Indian students for decades now. Standing at the prominent 8th position in the world in terms of the quality of medical education, Russia has been home to thousands of Indian MBBS students who are working as renowned and well-established doctors today . <br />
                        As India and Uzbekistan share a cordial and friendly relationship, the government of the Russian Federation offers subsidized medical education to Indian students. The affordability of MBBS in Russia encourages many Indian medical aspirants to pursue their dreams in this largest country in the world which is home to more than 25 top medical universities around the globe. </p>
                    </div>
                </div>
            </div>
    </>
