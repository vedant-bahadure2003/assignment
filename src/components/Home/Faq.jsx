...
const Faq = () => {
  ...
  return (
    <div className="w-[90%] md:w-[80%] mx-auto mt-[50px] md:mt-[71px]">
      ...
      <div className="flex flex-col gap-2 md:gap-4 divide-y mt-5 md:mt-10 w-[90%] md:w-[80%] mx-auto shadow-md shadow-gray-400  md:shadow-none p-3 md:p-0 border border-gray-200">
        {faqs.map((d, i) => (
          <Accordion
            key={i}
            answer={d.answer}
