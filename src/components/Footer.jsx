...
const Footer = () => {
    return (
        <>
            <div className="bg-gradient-to-t from-[#4dc5cb] to-[#aee4e7] h-auto  flex items-center justify-center flex-col p-4">
                <div className="w-full md:w-[90%] flex flex-col flex-wrap  md:flex-row gap-8 md:gap-5 items-center justify-center md:justify-evenly">
                    ...
                    <div className="flex flex-col md:flex-row gap-8">
                        ...
                        <div className="w-full md:w-[200px] flex flex-col items-center md:items-start gap-5">
                            <div className="font-semibold text-xl w-full text-center xl:text-left">Company</div>
                            <div className="flex flex-col items-center xl:items-start text-[16px] md:text-[18px] gap-3 w-full">
                                <h1>About</h1>
                                <h1>Feature</h1>
                                <h1>Work</h1>
                                <h1>Career</h1>
                        ...
                        <div className="w-full md:w-[200px] flex flex-col items-center md:items-start gap-5">
                            <div className="font-semibold text-xl w-full text-center xl:text-left">Help</div>
                            <div className="flex flex-col items-center xl:items-start text-[16px] md:text-[18px] gap-3 w-full">
                        ...
                        <div className="w-full md:w-[200px] flex flex-col items-center md:items-start gap-5">
                            <div className="font-semibold text-xl w-full text-center xl:text-left">Resource</div>
                            <div className="flex flex-col items-center xl:items-start text-[16px] md:text-[18px] gap-3 w-full">
                                <h1>Free eBooks</h1>
